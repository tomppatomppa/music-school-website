...
const Teacher = () => {
  return (
    <section className="bg-hero2 w-full shadow-xl md:h-[90vh]  flex md:items-center  ">
      <div className="container ">
        <Title title="OPETTAJA" description="Pedagoogiset valmiudet" />
        <div className="flex md:bg-none  flex-col md:flex-row-reverse items-center gap-2 bg-red-50 shadow-xl  ">
